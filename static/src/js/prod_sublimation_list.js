...
export class ProdSublimationListController extends ListController {
    setup() {
        super.setup();
...
registry.category("views").add("prod_sublimation_list", {
    ...listView,
    Controller: ProdSublimationListController,
});
